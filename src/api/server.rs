...
pub fn api_router() -> OpenApiRouter<Arc<ApiState>> {
    OpenApiRouter::with_openapi(ApiDoc::openapi())
        ...
        .routes(routes!(tasks::restore_task_revision))
        // Wiki routes
        ...
        .routes(routes!(skills::pin_skill))
        .routes(routes!(skills::adopt_skill))
        .routes(routes!(skills::archive_skill))
        .routes(routes!(skills::restore_skill))
        ...
        .routes(routes!(providers::get_provider_default_models))
