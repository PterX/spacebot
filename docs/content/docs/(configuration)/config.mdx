...
| `authority` | string[] | [] | Authority list for this instance's slash commands |
...
| `authority` | string[] | User IDs allowed to run authority-gated slash commands in this scope. Empty = open to everyone the binding admits |
